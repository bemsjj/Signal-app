...
import LoginFront from "./components/loginFront.component";
...
import GererSignalementFront from "./components/GererSignalementFront.component";
import EditSignalement from "./components/EditSignalement.component";
import EditSignalementFront from "./components/EditSignalementFront.component";
import AddTypeSignalement from "./components/AddTypeSignalement.component";
import DashboardFront from "./components/DashboardFront.component";
import {connect} from 'react-redux';

function App(props) {
  const stores = props;
  console.log(stores.isAuth)
  return (<Router>
    <div className="App">
          <Switch>
